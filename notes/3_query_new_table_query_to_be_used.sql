...
-- https://drive.google.com/drive/folders/1GC0_6CugUBxb82Ulc-zHSiukK98vdfwr
...
from datalake.doubleclicksearch_v1_conversion c
    where "transaction id" is not null
      ...
      and conversiontimestamp::date >= '2020-07-01'
      and conversiontimestamp::date < '2020-12-01'
);

insert into  user_temp_schema.search_activations_nd
(
